...
const config: HardhatUserConfig = {
  ...
  ethernal: {
    ...
    disabled: process.env.ETHERNAL_DISABLED === "true", // If set to true, the plugin will be disabled, nohting will be synced, ethernal.push won't do anything either
