...
describe("SafEth", function () {
  ...
  describe.only("Pre-mint", function () {
    ...
    it.only("Should continue to stake with a similar price before and after all pre minted funds are used up", async function () {
      ...
      console.log('a1', safEthReceived1.toString());
      console.log('a2', ethAmount1.toString());
