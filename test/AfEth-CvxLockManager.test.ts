...
describe("AfEth (CvxLockManager)", async function () {
  ...
  it("Should show that cvxToLeaveUnlocked has expected values always equals cvx balance", async function () {
    ...
    expect(leaveUnlocked2).eq(cvxBalance2).eq("606254958530239518597");
    ...
    expect(leaveUnlocked21).eq(cvxBalance21).eq("606254958530239518597");
    ...
    expect(leaveUnlocked22).eq(cvxBalance22).eq("1205464479722161587197");
    ...
    expect(userCvxBalance).eq("1205464479722161587197");
  });
